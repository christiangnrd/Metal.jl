...
@objcproperties MPSMatrixSum begin
    ...
    @autoproperty neuronParameterA::Float32
    @autoproperty neuronParameterB::Float32
    @autoproperty neuronParameterC::Float32
    @autoproperty resultMatrixOrigin::MTLOrigin
