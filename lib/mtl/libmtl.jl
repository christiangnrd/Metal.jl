...
@objcwrapper immutable = true availability = v"14.0.0" MTLArchitecture <: NSObject
...
@objcproperties MTLDevice begin
    ...
    @autoproperty architecture::id{MTLArchitecture} availability = v"14.0.0"
    ...
    @autoproperty shouldMaximizeConcurrentCompilation::Bool setter = setShouldMaximizeConcurrentCompilation availability = v"13.3.0"
    @autoproperty maximumConcurrentCompilationTaskCount::UInt64 availability = v"13.3.0"
end
...
@objcwrapper immutable = true availability = v"15.0.0" MTLAllocation <: NSObject
...
@objcproperties MTLCompileOptions begin
    ...
    @autoproperty mathMode::MTLMathMode setter = setMathMode availability = v"15.0.0"
    @autoproperty mathFloatingPointFunctions::MTLMathFloatingPointFunctions setter = setMathFloatingPointFunctions availability = v"15.0.0"
    ...
    @autoproperty compileSymbolVisibility::MTLCompileSymbolVisibility setter = setCompileSymbolVisibility availability = v"13.3.0"
    @autoproperty allowReferencingUndefinedSymbols::Bool setter = setAllowReferencingUndefinedSymbols availability = v"13.3.0"
    @autoproperty maxTotalThreadsPerThreadgroup::UInt64 setter = setMaxTotalThreadsPerThreadgroup availability = v"13.3.0"
    @autoproperty enableLogging::Bool setter = setEnableLogging availability = v"15.0.0"
end
...
@objcwrapper immutable = true availability = v"15.0.0" MTLLogState <: NSObject
...
@objcproperties MTLCommandBufferDescriptor begin
    ...
    @autoproperty logState::id{MTLLogState} setter = setLogState availability = v"15.0.0"
end
...
@objcwrapper immutable = true availability = v"15.0.0" MTLCommandQueueDescriptor <: NSObject
...
@objcproperties MTLComputePipelineDescriptor begin
    ...
    @autoproperty shaderValidation::MTLShaderValidation setter = setShaderValidation availability = v"15.0.0"
end
...
@objcproperties MTLComputePipelineState begin
    ...
    @autoproperty gpuResourceID::MTLResourceID
    @autoproperty shaderValidation::MTLShaderValidation availability = v"15.0.0"
end
...
@objcproperties MTLMeshRenderPipelineDescriptor begin
    ...
    @autoproperty depthAttachmentPixelFormat::MTLPixelFormat setter = setDepthAttachmentPixelFormat
    @autoproperty stencilAttachmentPixelFormat::MTLPixelFormat setter = setStencilAttachmentPixelFormat
    @autoproperty supportIndirectCommandBuffers::Bool setter = setSupportIndirectCommandBuffers availability = v"14.0.0"
    @autoproperty binaryArchives::id{NSArray} type = Vector{MTLBinaryArchive} setter = setBinaryArchives availability = v"15.0.0"
    @autoproperty objectLinkedFunctions::id{MTLLinkedFunctions} setter = setObjectLinkedFunctions availability = v"14.0.0"
    @autoproperty meshLinkedFunctions::id{MTLLinkedFunctions} setter = setMeshLinkedFunctions availability = v"14.0.0"
    @autoproperty fragmentLinkedFunctions::id{MTLLinkedFunctions} setter = setFragmentLinkedFunctions availability = v"14.0.0"
    @autoproperty shaderValidation::MTLShaderValidation setter = setShaderValidation availability = v"15.0.0"
end
...
@objcproperties MTLAccelerationStructureTriangleGeometryDescriptor begin
    ...
    @autoproperty transformationMatrixLayout::MTLMatrixLayout setter = setTransformationMatrixLayout availability = v"15.0.0"
end
...
@objcwrapper immutable = true availability = v"14.0.0" MTLAccelerationStructureCurveGeometryDescriptor <: MTLAccelerationStructureGeometryDescriptor
...
@objcwrapper immutable = true availability = v"14.0.0" MTLAccelerationStructureMotionCurveGeometryDescriptor <: MTLAccelerationStructureGeometryDescriptor
...
@objcproperties MTLInstanceAccelerationStructureDescriptor begin
    ...
    @autoproperty instanceTransformationMatrixLayout::MTLMatrixLayout setter = setInstanceTransformationMatrixLayout availability = v"15.0.0"
    @autoproperty motionTransformType::MTLTransformType setter = setMotionTransformType availability = v"15.0.0"
    @autoproperty motionTransformStride::UInt64 setter = setMotionTransformStride availability = v"15.0.0"
end

@objcwrapper immutable = true availability = v"14.0.0" MTLIndirectInstanceAccelerationStructureDescriptor <: MTLAccelerationStructureDescriptor
...
@objcproperties MTLIndirectCommandBufferDescriptor begin
    ...
    @autoproperty maxKernelThreadgroupMemoryBindCount::UInt64 setter = setMaxKernelThreadgroupMemoryBindCount availability = v"14.0.0"
    @autoproperty maxObjectBufferBindCount::UInt64 setter = setMaxObjectBufferBindCount availability = v"14.0.0"
    @autoproperty maxMeshBufferBindCount::UInt64 setter = setMaxMeshBufferBindCount availability = v"14.0.0"
    @autoproperty maxObjectThreadgroupMemoryBindCount::UInt64 setter = setMaxObjectThreadgroupMemoryBindCount availability = v"14.0.0"
    @autoproperty supportRayTracing::Bool setter = setSupportRayTracing
    @autoproperty supportDynamicAttributeStride::Bool setter = setSupportDynamicAttributeStride availability = v"14.0.0"
end
...
@objcwrapper immutable = true availability = v"15.0.0" MTLLogStateDescriptor <: NSObject
...
@objcproperties MTLStitchedLibraryDescriptor begin
    ...
    @autoproperty functions::id{NSArray} type = Vector{MTLFunction} setter = setFunctions
    @autoproperty binaryArchives::id{NSArray} type = Vector{MTLBinaryArchive} setter = setBinaryArchives availability = v"15.0.0"
    @autoproperty options::MTLStitchedLibraryOptions setter = setOptions availability = v"15.0.0"
end
...
@objcwrapper immutable = true availability = v"15.0.0" MTLResidencySetDescriptor <: NSObject
...
@objcwrapper immutable = true availability = v"15.0.0" MTLResidencySet <: NSObject
